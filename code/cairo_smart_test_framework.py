...
class CairoTest:
    ...
    def invoke_function_by_name(self, func_name : str, inputs_dict : Dict[str, int], builtins : List[str]):
    ...
    def invoke_function(self, func_class : AbstractCairoFunctionClass, argument_values : List[int]):
    ...
    def run(
        ...
        try:
            ...
            # ... and test whether the successful run (inputs, outputs) is "good" or "bad".
            ...
            # If invoking `test_class` on these arguments raised a runtime error, test whether the inputs are "good" or "bad".  Perhaps failure was to be expected, after all.
    ...
    def run_tests_with(self, list_of_test_classes : List[AbstractCairoTestClass], argument_values : List[int]):
...
class SmartTest:
    ...
    def run(self, SomeCairoTestClass : AbstractCairoTestClass, some_arguments : List[int]):
    ...
    # A convenient passthrough method to CairoTest.invoke_function.
