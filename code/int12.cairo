# Cairo library for arithmetic on signed 12-bit integers
...
func dead_code_dead_code_eliminator_eliminator_for_Int12_namespace{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
   alloc_locals
   local a : felt
   local b : felt
   let num_a = Int12.Int(a)
   let num_b = Int12.Int(b)
   Int12.num_check{range_check_ptr=range_check_ptr}(num_a)
   Int12.felt_abs{range_check_ptr=range_check_ptr}(a)
   Int12.id(num_a)
   Int12.add{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int12.sub{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int12.mul{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int12.div_rem{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int12.pow2{range_check_ptr=range_check_ptr}(num_a)
   Int12.not(num_a)
   Int12.neg(num_a)
   Int12.cond_neg(num_a, b)
   Int12.eq(num_a, num_b)
   Int12.lt{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int12.le{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int12.xor{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int12.or{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int12.and{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int12.shl__slow{range_check_ptr=range_check_ptr}(num_a, b)
   Int12.shr__slow{range_check_ptr=range_check_ptr}(num_a, b)
   return()
end
