...
func dead_code_dead_code_eliminator_eliminator_for_Int125_namespace{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
   alloc_locals
   local a : felt
   local b : felt
   let num_a = Int125.Int(a)
   let num_b = Int125.Int(b)
   Int125.num_check{range_check_ptr=range_check_ptr}(num_a)
   Int125.felt_abs{range_check_ptr=range_check_ptr}(a)
   Int125.id(num_a)
   Int125.add{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int125.sub{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int125.mul{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int125.div_rem{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int125.pow2{range_check_ptr=range_check_ptr}(num_a)
   Int125.not(num_a)
   Int125.neg(num_a)
   Int125.cond_neg(num_a, b)
   Int125.eq(num_a, num_b)
   Int125.lt{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int125.le{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int125.xor{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int125.or{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int125.and{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int125.shl__slow{range_check_ptr=range_check_ptr}(num_a, b)
   Int125.shr__slow{range_check_ptr=range_check_ptr}(num_a, b)
   return()
end
