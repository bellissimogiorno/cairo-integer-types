# Cairo library for arithmetic on signed 16-bit integers
...
func dead_code_dead_code_eliminator_eliminator_for_Int16_namespace{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
   alloc_locals
   local a : felt
   local b : felt
   let num_a = Int16.Int(a)
   let num_b = Int16.Int(b)
   Int16.num_check{range_check_ptr=range_check_ptr}(num_a)
   Int16.felt_abs{range_check_ptr=range_check_ptr}(a)
   Int16.id(num_a)
   Int16.add{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int16.sub{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int16.mul{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int16.div_rem{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int16.pow2{range_check_ptr=range_check_ptr}(num_a)
   Int16.not(num_a)
   Int16.neg(num_a)
   Int16.cond_neg(num_a, b)
   Int16.eq(num_a, num_b)
   Int16.lt{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int16.le{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int16.xor{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int16.or{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int16.and{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int16.shl__slow{range_check_ptr=range_check_ptr}(num_a, b)
   Int16.shr__slow{range_check_ptr=range_check_ptr}(num_a, b)
   return()
end
