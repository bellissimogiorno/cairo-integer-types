# Cairo library for arithmetic on signed 4-bit integers
...
func dead_code_dead_code_eliminator_eliminator_for_Int4_namespace{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
   alloc_locals
   local a : felt
   local b : felt
   let num_a = Int4.Int(a)
   let num_b = Int4.Int(b)
   Int4.num_check{range_check_ptr=range_check_ptr}(num_a)
   Int4.felt_abs{range_check_ptr=range_check_ptr}(a)
   Int4.id(num_a)
   Int4.add{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int4.sub{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int4.mul{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int4.div_rem{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int4.pow2{range_check_ptr=range_check_ptr}(num_a)
   Int4.not(num_a)
   Int4.neg(num_a)
   Int4.cond_neg(num_a, b)
   Int4.eq(num_a, num_b)
   Int4.lt{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int4.le{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int4.xor{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int4.or{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int4.and{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int4.shl__slow{range_check_ptr=range_check_ptr}(num_a, b)
   Int4.shr__slow{range_check_ptr=range_check_ptr}(num_a, b)
   return()
end
