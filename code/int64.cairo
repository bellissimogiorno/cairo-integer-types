# Cairo library for arithmetic on signed 64-bit integers
...
func dead_code_dead_code_eliminator_eliminator_for_Int64_namespace{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
   alloc_locals
   local a : felt
   local b : felt
   let num_a = Int64.Int(a)
   let num_b = Int64.Int(b)
   Int64.num_check{range_check_ptr=range_check_ptr}(num_a)
   Int64.felt_abs{range_check_ptr=range_check_ptr}(a)
   Int64.id(num_a)
   Int64.add{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int64.sub{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int64.mul{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int64.div_rem{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int64.pow2{range_check_ptr=range_check_ptr}(num_a)
   Int64.not(num_a)
   Int64.neg(num_a)
   Int64.cond_neg(num_a, b)
   Int64.eq(num_a, num_b)
   Int64.lt{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int64.le{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int64.xor{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int64.or{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int64.and{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int64.shl__slow{range_check_ptr=range_check_ptr}(num_a, b)
   Int64.shr__slow{range_check_ptr=range_check_ptr}(num_a, b)
   return()
end
