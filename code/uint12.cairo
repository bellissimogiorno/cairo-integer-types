# Cairo library for arithmetic on unsigned 12-bit integers
...
func dead_code_dead_code_eliminator_eliminator_for_Uint12_namespace{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
   alloc_locals
   local a : felt
   local b : felt
   let num_a = Uint12.Uint(a)
   let num_b = Uint12.Uint(b)
   Uint12.num_check{range_check_ptr=range_check_ptr}(num_a)
   Uint12.add{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint12.sub{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint12.mul{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint12.div_rem{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint12.pow2{range_check_ptr=range_check_ptr}(num_a)
   Uint12.not(num_a)
   Uint12.neg(num_a)
   Uint12.cond_neg(num_a, b)
   Uint12.eq(num_a, num_b)
   Uint12.lt{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint12.le{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint12.xor{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint12.or{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint12.and{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint12.shl__slow{range_check_ptr=range_check_ptr}(num_a, b)
   Uint12.shr__slow{range_check_ptr=range_check_ptr}(num_a, b)
   return()
end
