# Cairo library for arithmetic on unsigned 125-bit integers
...
func dead_code_dead_code_eliminator_eliminator_for_Uint125_namespace{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
   alloc_locals
   local a : felt
   local b : felt
   let num_a = Uint125.Uint(a)
   let num_b = Uint125.Uint(b)
   Uint125.num_check{range_check_ptr=range_check_ptr}(num_a)
   Uint125.add{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint125.sub{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint125.mul{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint125.div_rem{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint125.pow2{range_check_ptr=range_check_ptr}(num_a)
   Uint125.not(num_a)
   Uint125.neg(num_a)
   Uint125.cond_neg(num_a, b)
   Uint125.eq(num_a, num_b)
   Uint125.lt{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint125.le{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint125.xor{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint125.or{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint125.and{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint125.shl__slow{range_check_ptr=range_check_ptr}(num_a, b)
   Uint125.shr__slow{range_check_ptr=range_check_ptr}(num_a, b)
   return()
end
