# Cairo library for arithmetic on unsigned 16-bit integers
...
func dead_code_dead_code_eliminator_eliminator_for_Uint16_namespace{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
   alloc_locals
   local a : felt
   local b : felt
   let num_a = Uint16.Uint(a)
   let num_b = Uint16.Uint(b)
   Uint16.num_check{range_check_ptr=range_check_ptr}(num_a)
   Uint16.add{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint16.sub{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint16.mul{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint16.div_rem{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint16.pow2{range_check_ptr=range_check_ptr}(num_a)
   Uint16.not(num_a)
   Uint16.neg(num_a)
   Uint16.cond_neg(num_a, b)
   Uint16.eq(num_a, num_b)
   Uint16.lt{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint16.le{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint16.xor{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint16.or{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint16.and{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint16.shl__slow{range_check_ptr=range_check_ptr}(num_a, b)
   Uint16.shr__slow{range_check_ptr=range_check_ptr}(num_a, b)
   return()
end
