# Cairo library for arithmetic on unsigned 64-bit integers
...
func dead_code_dead_code_eliminator_eliminator_for_Uint64_namespace{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
   alloc_locals
   local a : felt
   local b : felt
   let num_a = Uint64.Uint(a)
   let num_b = Uint64.Uint(b)
   Uint64.num_check{range_check_ptr=range_check_ptr}(num_a)
   Uint64.add{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint64.sub{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint64.mul{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint64.div_rem{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint64.pow2{range_check_ptr=range_check_ptr}(num_a)
   Uint64.not(num_a)
   Uint64.neg(num_a)
   Uint64.cond_neg(num_a, b)
   Uint64.eq(num_a, num_b)
   Uint64.lt{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint64.le{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint64.xor{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint64.or{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint64.and{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint64.shl__slow{range_check_ptr=range_check_ptr}(num_a, b)
   Uint64.shr__slow{range_check_ptr=range_check_ptr}(num_a, b)
   return()
end
