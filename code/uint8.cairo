# Cairo library for arithmetic on unsigned 8-bit integers
...
func dead_code_dead_code_eliminator_eliminator_for_Uint8_namespace{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
   alloc_locals
   local a : felt
   local b : felt
   let num_a = Uint8.Uint(a)
   let num_b = Uint8.Uint(b)
   Uint8.num_check{range_check_ptr=range_check_ptr}(num_a)
   Uint8.add{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint8.sub{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint8.mul{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint8.div_rem{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint8.pow2{range_check_ptr=range_check_ptr}(num_a)
   Uint8.not(num_a)
   Uint8.neg(num_a)
   Uint8.cond_neg(num_a, b)
   Uint8.eq(num_a, num_b)
   Uint8.lt{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint8.le{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint8.xor{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint8.or{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint8.and{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint8.shl__slow{range_check_ptr=range_check_ptr}(num_a, b)
   Uint8.shr__slow{range_check_ptr=range_check_ptr}(num_a, b)
   return()
end
