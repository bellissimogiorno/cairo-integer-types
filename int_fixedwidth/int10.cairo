# Cairo library for arithmetic on signed 10-bit integers
...
func dead_code_dead_code_eliminator_eliminator_for_Int10_namespace{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
   alloc_locals
   local a : felt
   local b : felt
   let num_a = Int10.Int(a)
   let num_b = Int10.Int(b)
   Int10.num_check{range_check_ptr=range_check_ptr}(num_a)
   Int10.felt_abs{range_check_ptr=range_check_ptr}(a)
   Int10.id(num_a)
   Int10.add{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int10.sub{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int10.mul{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int10.div_rem{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int10.pow2{range_check_ptr=range_check_ptr}(num_a)
   Int10.not(num_a)
   Int10.neg(num_a)
   Int10.cond_neg(num_a, b)
   Int10.eq(num_a, num_b)
   Int10.lt{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int10.le{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int10.xor{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int10.or{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int10.and{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int10.shl__slow{range_check_ptr=range_check_ptr}(num_a, b)
   Int10.shr__slow{range_check_ptr=range_check_ptr}(num_a, b)
   return()
end
