# Cairo library for arithmetic on signed 124-bit integers
...
func dead_code_dead_code_eliminator_eliminator_for_Int124_namespace{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
   alloc_locals
   local a : felt
   local b : felt
   let num_a = Int124.Int(a)
   let num_b = Int124.Int(b)
   Int124.num_check{range_check_ptr=range_check_ptr}(num_a)
   Int124.felt_abs{range_check_ptr=range_check_ptr}(a)
   Int124.id(num_a)
   Int124.add{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int124.sub{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int124.mul{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int124.div_rem{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int124.pow2{range_check_ptr=range_check_ptr}(num_a)
   Int124.not(num_a)
   Int124.neg(num_a)
   Int124.cond_neg(num_a, b)
   Int124.eq(num_a, num_b)
   Int124.lt{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int124.le{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int124.xor{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int124.or{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int124.and{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int124.shl__slow{range_check_ptr=range_check_ptr}(num_a, b)
   Int124.shr__slow{range_check_ptr=range_check_ptr}(num_a, b)
   return()
end
