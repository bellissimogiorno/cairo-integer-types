# Cairo library for arithmetic on signed 6-bit integers
...
func dead_code_dead_code_eliminator_eliminator_for_Int6_namespace{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
   alloc_locals
   local a : felt
   local b : felt
   let num_a = Int6.Int(a)
   let num_b = Int6.Int(b)
   Int6.num_check{range_check_ptr=range_check_ptr}(num_a)
   Int6.felt_abs{range_check_ptr=range_check_ptr}(a)
   Int6.id(num_a)
   Int6.add{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int6.sub{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int6.mul{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int6.div_rem{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int6.pow2{range_check_ptr=range_check_ptr}(num_a)
   Int6.not(num_a)
   Int6.neg(num_a)
   Int6.cond_neg(num_a, b)
   Int6.eq(num_a, num_b)
   Int6.lt{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int6.le{range_check_ptr=range_check_ptr}(num_a, num_b)
   Int6.xor{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int6.or{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int6.and{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Int6.shl__slow{range_check_ptr=range_check_ptr}(num_a, b)
   Int6.shr__slow{range_check_ptr=range_check_ptr}(num_a, b)
   return()
end
