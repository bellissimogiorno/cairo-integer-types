# Cairo library for arithmetic on unsigned 124-bit integers
...
func dead_code_dead_code_eliminator_eliminator_for_Uint124_namespace{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
   alloc_locals
   local a : felt
   local b : felt
   let num_a = Uint124.Uint(a)
   let num_b = Uint124.Uint(b)
   Uint124.num_check{range_check_ptr=range_check_ptr}(num_a)
   Uint124.add{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint124.sub{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint124.mul{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint124.div_rem{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint124.pow2{range_check_ptr=range_check_ptr}(num_a)
   Uint124.not(num_a)
   Uint124.neg(num_a)
   Uint124.cond_neg(num_a, b)
   Uint124.eq(num_a, num_b)
   Uint124.lt{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint124.le{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint124.xor{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint124.or{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint124.and{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint124.shl__slow{range_check_ptr=range_check_ptr}(num_a, b)
   Uint124.shr__slow{range_check_ptr=range_check_ptr}(num_a, b)
   return()
end
