# Cairo library for arithmetic on unsigned 4-bit integers
...
func dead_code_dead_code_eliminator_eliminator_for_Uint4_namespace{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
   alloc_locals
   local a : felt
   local b : felt
   let num_a = Uint4.Uint(a)
   let num_b = Uint4.Uint(b)
   Uint4.num_check{range_check_ptr=range_check_ptr}(num_a)
   Uint4.add{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint4.sub{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint4.mul{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint4.div_rem{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint4.pow2{range_check_ptr=range_check_ptr}(num_a)
   Uint4.not(num_a)
   Uint4.neg(num_a)
   Uint4.cond_neg(num_a, b)
   Uint4.eq(num_a, num_b)
   Uint4.lt{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint4.le{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint4.xor{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint4.or{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint4.and{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint4.shl__slow{range_check_ptr=range_check_ptr}(num_a, b)
   Uint4.shr__slow{range_check_ptr=range_check_ptr}(num_a, b)
   return()
end
