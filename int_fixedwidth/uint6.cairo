# Cairo library for arithmetic on unsigned 6-bit integers
...
func dead_code_dead_code_eliminator_eliminator_for_Uint6_namespace{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
   alloc_locals
   local a : felt
   local b : felt
   let num_a = Uint6.Uint(a)
   let num_b = Uint6.Uint(b)
   Uint6.num_check{range_check_ptr=range_check_ptr}(num_a)
   Uint6.add{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint6.sub{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint6.mul{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint6.div_rem{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint6.pow2{range_check_ptr=range_check_ptr}(num_a)
   Uint6.not(num_a)
   Uint6.neg(num_a)
   Uint6.cond_neg(num_a, b)
   Uint6.eq(num_a, num_b)
   Uint6.lt{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint6.le{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint6.xor{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint6.or{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint6.and{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint6.shl__slow{range_check_ptr=range_check_ptr}(num_a, b)
   Uint6.shr__slow{range_check_ptr=range_check_ptr}(num_a, b)
   return()
end
