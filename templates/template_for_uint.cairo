...
func dead_code_dead_code_eliminator_eliminator_for_Uint{{BIT_LENGTH}}_namespace{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
   alloc_locals
   local a : felt
   local b : felt
   let num_a = Uint{{BIT_LENGTH}}.Uint(a)
   let num_b = Uint{{BIT_LENGTH}}.Uint(b)
   Uint{{BIT_LENGTH}}.num_check{range_check_ptr=range_check_ptr}(num_a)
   Uint{{BIT_LENGTH}}.add{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint{{BIT_LENGTH}}.sub{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint{{BIT_LENGTH}}.mul{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint{{BIT_LENGTH}}.div_rem{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint{{BIT_LENGTH}}.pow2{range_check_ptr=range_check_ptr}(num_a)
   Uint{{BIT_LENGTH}}.not(num_a)
   Uint{{BIT_LENGTH}}.neg(num_a)
   Uint{{BIT_LENGTH}}.cond_neg(num_a, b)
   Uint{{BIT_LENGTH}}.eq(num_a, num_b)
   Uint{{BIT_LENGTH}}.lt{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint{{BIT_LENGTH}}.le{range_check_ptr=range_check_ptr}(num_a, num_b)
   Uint{{BIT_LENGTH}}.xor{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint{{BIT_LENGTH}}.or{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint{{BIT_LENGTH}}.and{range_check_ptr=range_check_ptr, bitwise_ptr=bitwise_ptr}(num_a, num_b)
   Uint{{BIT_LENGTH}}.shl__slow{range_check_ptr=range_check_ptr}(num_a, b)
   Uint{{BIT_LENGTH}}.shr__slow{range_check_ptr=range_check_ptr}(num_a, b)
   return()
end
